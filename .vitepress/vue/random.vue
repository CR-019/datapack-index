...
<template>
  ...
  /*愚人节限定
     ...
     `<a href=http://localhost:5173/datapack-index/feature/index/202603.html target="_blank">最新一期的《Bug》你看了吗？</a>`,
  ...
  const paragraphsZh = [
    ...
    `Mojang教你可数和不可数`,
    `数据包版本现在为<del>15</del> <del>18</del> <del>26</del> <del>41</del> <del>48</del> <del>57</del> <del>61</del> <del>71</del> <del>80</del> <del>81</del> <del>82.0</del> <del>88.0</del> <del94.1</del> 101.1!`,
    `着色器！`,
    `物品组件！`,
    `神 金 包`,
    `这是Datapack，它散架辣！`,
