...
import int from '/datapack-index/.vitepress/vue/nbt/int.vue'
import byte from '/datapack-index/.vitepress/vue/nbt/byte.vue'
import str from '/datapack-index/.vitepress/vue/nbt/string.vue'
import short from '/datapack-index/.vitepress/vue/nbt/short.vue'
import float from '/datapack-index/.vitepress/vue/nbt/float.vue'
import double from '/datapack-index/.vitepress/vue/nbt/double.vue'
import long from '/datapack-index/.vitepress/vue/nbt/long.vue'
...
import homolist from '/datapack-index/.vitepress/vue/nbt/homolist.vue'
import bool from '/datapack-index/.vitepress/vue/nbt/boolean.vue'
</script>
...
香草图书馆支持类似Wiki的NBT图标展示，如：
 ...
 - <ns /> # 命名空间ID
 - <nbt type="any" /> # 任意
 - <nbt type="byte_array" /> # 字节型数组
 - <nbt type="int_array" /> # 整型数组
 - <nbt type="long_array" /> # 长整型数组
...
且允许添加额外的文字，如
- `<short t = "air"/>`：<short t = "air"/>
- `<nbt type="int_array" t = "UUID"/>`：<nbt type="int_array" t = "UUID"/>

### NBT树展示支持

香草图书馆支持类似Wiki的NBT数据结构展示形式。
