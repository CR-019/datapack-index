...
# 数据操作：[NBT](https://zh.minecraft.wiki/w/?curid=145849)(数据储存/修改)
<ColorLine :height="4"/>
...
### 物品数据格式
- 物品NBT（已淘汰） `~1.20.4`
  - [物品格式/Java版1.20.5前 - Minecraft Wiki](https://zh.minecraft.wiki/w/?curid=112518)
- 物品堆叠组件 `1.20.5+`
  - [数据组件 - Minecraft Wiki](https://zh.minecraft.wiki/w/?curid=113905)
  - [教程：物品堆叠组件 - Minecraft Wiki](https://zh.minecraft.wiki/w/?curid=119466)

### 方块实体NBT
  - [方块实体NBT - Minecraft Wiki](https://zh.minecraft.wiki/w/?curid=28990)
