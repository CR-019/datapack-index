# Brief introduction to inline loot table (predicate, item decorator)
...
## Comprehensive use of inline loot table (and its components) and macros
...
```mcfunction
#args required: events (with weight attribute as weight, default is 1)
