...
1. Due to a generation error, the end dimension$(15,77,15)$A huge amount of armor stands spawned everywhere, causing the game to crash. Now you need to`.mca`Delete all these armor stands in the file. What is the path to this file? (Please use version 26.1 and above to answer)

---

2. Display the entity on the renderer at the same time$x$、$y$and$z$Axis mirroring, write the corresponding`transformation`.
