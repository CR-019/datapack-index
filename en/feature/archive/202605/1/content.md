...
```mcfunction
#function->animation/ambient: #Specific animation controller function
scoreboard players add @s tick1 1
scoreboard players set @s tick2 24
execute if score @s tick1 > @s tick2 run scoreboard players set @s tick1 0 #cycle
item modify entity @s container.0 jujutsu:cmd
item modify entity @s container.0 jujutsu: makora/ambient #Change model mapping
```
### Play once/stop at last frame

```mcfunction
#function->animation/xxx/action
scoreboard players set @s tick2 24
item modify entity @s container.0 jujutsu: makora/ambient #Change model mapping
```
