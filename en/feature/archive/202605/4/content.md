...
## Video introduction:
[[MC Multiplayer PVP Map] Digging Underground official version released!!! | Digging Underground-bilibili](https://www.bilibili.com/video/BV1Hj9ZBKEqq)


## Game introduction

 - Collecting ore: The most important thing in the game is the ore resource, which is the core of all manufacturing. The generation of ore will be distributed regularly according to the level. You can open [advancement] to view the distribution of ore on different maps.
 - Making props: In the process of collecting ore, the player can make different props, which can provide effective help to himself, such as [drill] for mining the ore ahead.
