...
::: warning Disadvantages of the data pack
...
Example:
Give a player the speed to point directly left, directly up, and directly in front of him.
```mcfunction
...
- <node type="int" name="z" required=true></node> points to the speed of execution moving forward.
