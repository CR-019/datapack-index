...
<figure><img src="../../../../../feature/archive/202508/5/image.png" alt="Uncomment the debugging line to see the scanning and calculation process" /><figcaption style="font-size:12px;color:#666;text-align:center;">Uncomment the debugging line and you can see the scanning and calculation process</figcaption></figure>
