...
# How to use`yopo:encrypt_message`It is the entry function. Execute it, and it will handle the rest automatically, and finally tell you whether you got the permission or not. \
