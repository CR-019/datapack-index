...
<JournalHead
    ...
    :credits="['镇川']"
    :launchLink="{ link: '../archive/202603/ifc/content', text: 'Second cover' }"
...
<IndexCompatible
    ...
    abstract = "The &quot;Camera Animation Resource Library&quot; is a data pack module based on the spectator display entity and teleportcommand, and runs with pure command drive. It provides a complete camera animation system, allowing creators to easily create various complex camera movement effects through preset animation templates and custom parameters, thereby improving the visual expression and narrative capabilities in Minecraft."
/>
