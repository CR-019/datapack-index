...
<JournalHead
    ...
    :launchLink="{ link: '../archive/202512/ifc/content', text: 'Second cover' }"
...
<IndexCompatible
    title = "An infinite architectural structure with infinite degrees of freedom based on the world generation structure set."
