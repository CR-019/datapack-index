...
<JournalHead
    ...
    :credits="['御龙九秋','南烛']"
    :launchLink="{ link: '../archive/202504/preface', text: 'Inaugural message' }"
/>
...
<IndexCompatible
    title = "Picking up dust (7) - Using composite item model mapping to create a status bar more easily"
