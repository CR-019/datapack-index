...
- example:
  - ​	`{"text":"Hello"}`
    - After 1.14, you can not use escaping`\"`, instead use single quotes directly in the outer layer:`'" "'`
- tool:
...
## Text component format
  ...
  - [JSON Text Practical Manual](https://commandtutorials.neocities.org/tutorials/json/JSON) `1.9+`
  - [Use of "sub-object" in original json text](/datapack-index/save/1076989.html){target="_blank"}
  - [[CB Holy Code Project] JSON Holy Code-the most comprehensive JSON tutorial](/datapack-index/save/431678.html){target="_blank"} `1.8` `不推荐`
...
### font ["font"](https://zh.minecraft.wiki/w/%E6%96%87%E6%9C%AC%E7%BB%84%E4%BB%B6#%E5%AD%97%E4%BD%93)
  ...
  - [About the issue of font resource pack forcing the use of fixed-width characters](/datapack-index/save/1275778.html){target="_blank"} 
### Parse "interpret"
...
#### HoverEvent ["hoverEvent"](https://zh.minecraft.wiki/w/%E6%96%87%E6%9C%AC%E7%BB%84%E4%BB%B6#%E6%82%AC%E5%81%9C%E4%BA%8B%E4%BB%B6)
...
### JSON text information [/tellraw](https://zh.minecraft.wiki/w/%E5%91%BD%E4%BB%A4/tellraw)
  - [[CBL|SYL]Json/tellraw tutorial index post](/index/附录6.md#json)
...
### title [/title](https://zh.minecraft.wiki/w/%E5%91%BD%E4%BB%A4/title)
  ...
  - activity bar`actionbar`
    - [Ma Daha - I can see the kitten clearly! ! ! ](/datapack-index/save/1047712.html){target="_blank"} `（非物质文化遗产）`
...
### Score board [/scoreboard](/en/index/命令2-数据操作.md/#scoreboard)
`/scoreboard objectives setdisplay &lt;*槽位*> [*记分板ID*]`
  - sidebar`sidebar`
  - Character name`below`
  - player list`list`
  - [[1.14]How to connect bossbar and scoreboard](/datapack-index/save/864877.html){target="_blank"} `1.14`
...
- [Notice Board - Minecraft Wiki](https://zh.minecraft.wiki/w/%E5%91%8A%E7%A4%BA%E7%89%8C#%E6%96%B9%E5%9D%97%E5%AE%9E%E4%BD%93)
  ...
  - [[Water Tutorial][1.14+] Notice board black technology / implemented with loot table](/datapack-index/save/1101560.html){target="_blank"} `1.14`
