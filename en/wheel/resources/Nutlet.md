...
An API for creating simple multi-block machines, including
 - Easy enhancements`schedule`(NBT can be transferred via command storage)
 - Create temporary projections (to display the entity, it will disappear periodically even if the chunk is unloaded)
 ...
 - Execute location brightness acquisition
